...
import ch.makery.address.view.ControladorNew;
...
public class Main extends Application {
	...
	public void abrirNuevo(Person persona) {
		try {
			// Cargamos el FXML
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Main.class.getResource("view/New.fxml"));
			AnchorPane nueva = (AnchorPane) loader.load();
			...
			//Uso la persona que me manda por parámetro
